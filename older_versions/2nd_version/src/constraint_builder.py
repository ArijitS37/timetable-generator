"""
Constraint building module - COMPLETE REWRITE with all optimizations
All critical bugs fixed, efficient variable creation, and proper 2-hour block tracking
"""
...
class ConstraintBuilder:
    def __init__(self, subjects: List[Dict], teachers: List[str], rooms: List[str], 
                 ...
                 constraint_selector: ConstraintSelector, teacher_initials: Dict[str, str]):
